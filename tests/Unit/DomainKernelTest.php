...
class DomainKernelTest extends TestCase
{
    ...
    public function testConstructorSetsAllServices(): void
    {
        ...
        $eventListenerRegistry = $this->createMock(EventListenerRegistryInterface::class);
        ...
        $this->assertSame($eventListenerRegistry, $kernel->eventListenerRegistry());
    ...
    public function testNullableServices(): void
    {
        ...
        $this->assertNull($kernel->eventListenerRegistry());

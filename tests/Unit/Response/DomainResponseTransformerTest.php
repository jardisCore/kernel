...
namespace JardisCore\Domain\Tests\Unit\Response;

use JardisCore\Domain\ContextResult;
use JardisCore\Domain\Response\DomainResponseTransformer;
use JardisCore\Domain\Response\ResponseStatus;
...
class DomainResponseTransformerTest extends TestCase
{
    ...
    public function testTransformAggregatesDataFromSubResults(): void
    {
        ...
        $main = new ContextResult('PlaceOrder');
        $main->setData(['orderId' => 'ORD-123']);

        $sub = new ContextResult('CheckInventory');
    ...
    public function testTransformAggregatesErrorsFromSubResults(): void
    {
        ...
        $sub = new ContextResult('ChargePayment');
    ...
    public function testTransformCollectsAllContextsInMetadata(): void
    {
        ...
        $sub1 = new ContextResult('CheckInventory');
        $sub2 = new ContextResult('ChargePayment');
    ...
    public function testTransformDeduplicatesContextsInMetadata(): void
    {
        ...
        $main = new ContextResult('PlaceOrder');
        $sub = new ContextResult('PlaceOrder');
        $main->addResult($sub);
    ...
    public function testTransformDeeplyNestedResults(): void
    {
        ...
        $level1 = new ContextResult('Workflow');
        $level2 = new ContextResult('PlaceOrder');
        $level3 = new ContextResult('CheckInventory');

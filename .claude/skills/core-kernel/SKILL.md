...
- The Koffer core (`DomainKernel` + the contract interfaces it implements)
  stays adapter-free — only `jardissupport/contracts` + PSR interfaces. Adapter
